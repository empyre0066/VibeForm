...
export default function ClassicMugPage() {
  return (
    <main style={{ padding: "60px", maxWidth: "900px", margin: "0 auto" }}>
      ...
      <p style={{ marginBottom: "30px", fontSize: "16px", color: "#555" }}>
        A timeless mug designed for everyday use. Simple, strong, and personal.
      </p>

      {/* Product Preview */}
      <div style={previewBox}>
        <p style={{ color: "#888" }}>[ Mug Preview Image ]</p>
      </div>
      ...
      <div style={{ marginTop: "50px", fontSize: "14px", color: "#666" }}>
        Customization tools will appear here, allowing you to add text,
        images, or artwork directly on the mug.
      </div>
    </main>
  );
}
